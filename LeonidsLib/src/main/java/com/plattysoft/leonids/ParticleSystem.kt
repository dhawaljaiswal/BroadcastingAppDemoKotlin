...
class ParticleSystem private constructor(parentView: ViewGroup, private val mMaxParticles: Int, private val mTimeToLive: Long) {
     ...
     * @param parentViewId The view Id for the parent of the particle system
     */
    @JvmOverloads constructor(a: Activity, maxParticles: Int, drawable: Drawable, timeToLive: Long, parentViewId: Int = android.R.id.content) : this(a.findViewById(parentViewId) as ViewGroup, maxParticles, drawable, timeToLive) {}
     ...
     * @param parentViewId The view Id for the parent of the particle system
     */
    @JvmOverloads constructor(a: Activity, maxParticles: Int, bitmap: Bitmap, timeToLive: Long, parentViewId: Int = android.R.id.content) : this(a.findViewById(parentViewId) as ViewGroup, maxParticles, timeToLive) {
        for (i in 0 until mMaxParticles) {
            mParticles.add(Particle(bitmap))
        }
    }
     ...
     * @param parentViewId The view Id for the parent of the particle system
     */
    @JvmOverloads constructor(a: Activity, maxParticles: Int, animation: AnimationDrawable, timeToLive: Long, parentViewId: Int = android.R.id.content) : this(a.findViewById(parentViewId) as ViewGroup, maxParticles, timeToLive) {
        // Create the particles
        for (i in 0 until mMaxParticles) {
    ...
    private fun onUpdate(miliseconds: Long) {
        while ((mEmittingTime > 0 && miliseconds < mEmittingTime || mEmittingTime.toInt() == -1) && // This point should emit
